...
\profile{
  ...
  \birthday{1997-09-07}
  \texttt{求职意向:}{Linux系统运维，云计算方向，Devops}
  %\address{西安}
  % Custom information:
  % \icontext{<icon>}{<text>}
...
\begin{competences}
  ...
  \comptence{工具}{%
    SSH, Git, Make, Tmux, Vim, Openstcak, Ansible,Travis-Ci，KVM，MySQL
  }
...
%======================================================================
\sectionTitle{项目}{\faCode}
%======================================================================
\begin{itemize}
  \item \link{https://github.com/de-conf/arduino.io}{\texttt{arduino.io}}
  (Python,CSS,html)
  校园机房温度监控系统，配合arduino开发板和传感器实现温度监控和调节
